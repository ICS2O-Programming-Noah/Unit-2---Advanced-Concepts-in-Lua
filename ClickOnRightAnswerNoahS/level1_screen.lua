...
--You Win sound
--local youWinSound = audio.loadSound("Sounds/(name of sound)")
--local youWinSoundChannel

-- You lose sound
--local youLoseSound = audio.loadSound("Sounds/(name of sound)")
--local youLoseSoundChannel

-- Correct Sound
--local correctSound = audio.loadSound("Sounds/(name of sound)")
--local correctSoundChannel

--Incorrect Sound
--local incorrectSound = audio.loadSound("Sounds/(name of Sound)")
-----------------------------------------------------------------------------------------
-- LOCAL FUNCTIONS
-----------------------------------------------------------------------------------------
